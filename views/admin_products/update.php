            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="delete" class="btn btn-default" value="Удалить изображение">
                        ...
                        <p>Статус</p>
                        <select name="status">
                            <option value="1" <?php if ($product['statys'] == 1) echo ' selected="selected"'; ?>>Отображается</option>
                            <option value="0" <?php if ($product['statys'] == 0) echo ' selected="selected"'; ?>>Скрыт</option>
                        </select>
